...
import html2pdf from 'html2pdf.js'; // ✅ PDF LIBRARY IMPORTED
import './App.css';
...
function App() {
  ...
  // ✅ DIRECT HD PDF DOWNLOAD FUNCTION
  const downloadPDF = () => {
    // Temporary container taaki PDF mein white background aaye (Dark mode nahi)
    ...
    tempContainer.style.background = '#ffffff'; // White background
    ...
    const opt = {
      ...
      html2canvas:  { scale: 3 }, // HD Quality Zoom
